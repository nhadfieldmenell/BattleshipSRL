...
SddManager* sdd_manager_copy(SddSize size, SddNode** nodes, SddManager* from_manager); //NEW
...
//SddNode* sdd_apply_in_vtree(SddNode* node1, SddNode* node2, BoolOp op, Vtree* vtree, SddManager* manager); //REMOVED
